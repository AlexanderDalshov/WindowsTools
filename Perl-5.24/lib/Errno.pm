...
our %EXPORT_TAGS = (
    ...
    WINSOCK => [qw(
	WSAEBADF WSAENOBUFS WSAEINVALIDPROCTABLE WSAEDQUOT WSAEPROTOTYPE
	WSAEMFILE WSAETIMEDOUT WSAECONNABORTED WSAEALREADY WSAENOMORE
	WSAENETDOWN WSAEINTR WSAEUSERS WSAENOPROTOOPT WSAEADDRINUSE WSAEACCES
	WSAENETRESET WSAEISCONN WSAEPROCLIM WSAESTALE WSAEHOSTUNREACH
	WSAEADDRNOTAVAIL WSAECONNRESET WSAEINPROGRESS WSAECONNREFUSED
	WSAENAMETOOLONG WSAETOOMANYREFS WSAESHUTDOWN WSAEAFNOSUPPORT WSAELOOP
	WSAEINVALIDPROVIDER WSAEPFNOSUPPORT WSAEDESTADDRREQ WSAENOTSOCK
	WSAEPROTONOSUPPORT WSAECANCELLED WSAEREFUSED WSAENETUNREACH
	WSAESOCKTNOSUPPORT WSAENOTEMPTY WSAEMSGSIZE WSAEINVAL WSAEREMOTE
	WSAEOPNOTSUPP WSAEWOULDBLOCK WSAEHOSTDOWN WSAEPROVIDERFAILEDINIT
	WSAEFAULT WSAEDISCON WSAENOTCONN
    )],
);
